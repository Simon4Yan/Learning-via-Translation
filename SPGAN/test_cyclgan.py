...
with tf.Session() as sess:
    ...
    ckpt_path = utils.load_checkpoint('./checkpoints/' + dataset + '_cyclegan', sess, saver)
    ...
    a_save_dir = './test_predictions/' + dataset + '_cyclegan' + '/bounding_box_train_market2duke/'
    b_save_dir = './test_predictions/' + dataset + '_cyclegan' + '/bounding_box_train_duke2market/'
